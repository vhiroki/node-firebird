 ...
 */
exports.setDbCharset = function(charset) {
    DEFAULT_DB_CHARSET = charset;
};
...
Connection.prototype.attach = function (options, callback, db) {
    ...
    blr.addByte(1);
    blr.addString(isc_dpb_lc_ctype, DEFAULT_DB_CHARSET, DEFAULT_ENCODING);
...
Connection.prototype.createDatabase = function (options, callback) {
    ...
    blr.pos = 0;
    blr.addByte(1);
    blr.addString(isc_dpb_set_db_charset, DEFAULT_DB_CHARSET, DEFAULT_ENCODING);
    blr.addString(isc_dpb_lc_ctype, DEFAULT_DB_CHARSET, DEFAULT_ENCODING);
    blr.addString(isc_dpb_user_name, user, DEFAULT_ENCODING);
    blr.addString(isc_dpb_password, password, DEFAULT_ENCODING);
